...
bool StubSVocabulario :: alterarDefTermo(Nome& termo, Definicao& definicao) throw(runtime_error)
{
    ...
    Data dataFalha, dataErro, dataInserida;
    TextoDef txtDefFalha, txtDefErro, txtInserido;

    dataFalha.setData("09/06/2018");
    txtDefFalha.setTexto("Falha na definicao de termo");

    dataErro.setData("07/09/2014");
    txtDefErro.setTexto("Erro na definicao de termo");

    dataInserida=definicao.getData();
    txtInserido=definicao.getTexto();
    ...
    if(txtInserido.getTexto() == txtDefErro.getTexto())
    {
        resultado=TRIGGER_ERRO_DE_SISTEMA;
    }
    else
    {
        ...
        if(txtInserido.getTexto() == txtDefFalha.getTexto())
        {
            resultado = TRIGGER_FALHA;
        }
        else
...
Nome StubSVocabulario :: listarNomeVocabulario() throw(runtime_error)
{
    ...
    cout << endl << "StubSVocabulario :: pesquisarNomeVocabulario" << endl ;
...
/*--------------------------------------------Funcao Alterar Vocabulario------------------------------------------------*/

bool StubSVocabulario :: alterarDefVocabulario(Nome& nomeVocab, TextoDef& txtVocab) throw(runtime_error)
{

    cout << endl << "StubSVocabulario :: alterarVocabulario" << endl ;
    ...
    if(txtVocab.getTexto() == txtDefErro.getTexto())
    {
        resultado = TRIGGER_ERRO_DE_SISTEMA;
    }
    else
    {
        ...
        if(txtVocab.getTexto() == txtDefFalha.getTexto())
        {
            resultado = TRIGGER_FALHA;
        }
        else
...
bool StubSVocabulario :: alterarDefVocabulario(Nome& nomeVocab, TextoDef& txtDefVocab) throw(runtime_error)
{
    ...
    nomeFalha.setNome("Falha");
    txtDefFalha.setTexto("Falha na definicao de vocabulario");

    nomeErro.setNome("Bug");
    txtDefErro.setTexto("Erro na definicao de vocabulario");
